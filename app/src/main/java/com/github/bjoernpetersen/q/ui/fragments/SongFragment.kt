...
class SongFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val songs = this.songs ?: throw IllegalStateException("Songs should have been initialized in onCreate")
    ...
    override fun onAttach(context: Context) {
        ...
        else throw RuntimeException(context.toString() + " must implement OnListFragmentInteractionListener")
    }
