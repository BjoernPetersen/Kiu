...
private val TAG = SuggestActivity::class.java.simpleName

class SuggestActivity : AppCompatActivity(), SuggestFragment.OnFragmentInteractionListener, SongFragment.OnListFragmentInteractionListener {
...
internal class SuggestFragmentPagerAdapter(fm: FragmentManager, suggesters: List<NamedPlugin>) : FragmentPagerAdapter(fm) {
